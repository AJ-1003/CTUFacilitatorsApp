...
using CTUFacilitatorsApp.Data;
using CTUFacilitatorsApp.Models;
...
namespace CTUFacilitatorsApp.Controllers
{
    public class DetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Address1,Address2,Email")] Details details)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Address1,Address2,Email")] Details details)
        {
            if (id != details.Id)
            {
                return NotFound();
